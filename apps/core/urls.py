...
urlpatterns = [
    ...
    path("dailytodo_listview/",views.DailyTodo_view.as_view()),
    path("dailytodo_listview/<int:pk>/",views.DailyTodo_view.as_view()),

    
    path("historytodo_listview/",views.TodoHistory_view.as_view()),
    path("historytodo_listview/<int:pk>/",views.TodoHistory_view.as_view()),

    
    path("record_listview/",views.RecordTodo_view.as_view()),
